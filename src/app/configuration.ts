export const configuration = {
    header: {
        heading: 'Revolut1on Website',
        headingtext: 'IT-Revolut1on was here and control you until end',
        buttontext: 'Touch Me Baby',
        buttonlink: 'https://github.com/drow-ranger'
    },
    intro : {
        tagline: 'SUCCESS',
    ...
    footer: {
        ...
        developer: ' IT.Revolut1on ',
        developerlink: 'https://github.com/drow-ranger/webapp',
    },
    socialsites: [
        {link: 'https://www.facebook.com/', title: 'Facebook', target: '_blank', username: 'deo.nico', icon: 'facebook'},
        {link: 'https://plus.google.com/', title: 'Google+', target: '_blank', username: '102712812555195332449', icon: 'google-plus'},
        {link: 'https://twitter.com/', title: 'Twitter', target: '_blank', username: 'DNiconico_', icon: 'twitter'},
        {link: 'https://www.instagram.com/', title: 'Instagram', target: '_blank', username: 'deo.nico', icon: 'instagram'},
        //{link: ' ', title: 'Behance', target: '_blank', username: 'deo.nico', icon: 'behance'},
    ],
    blog: {
        tagline: 'MY BLOG',
